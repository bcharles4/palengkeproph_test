...
# Simple JWT settings - customize token lifetime here
from rest_framework_simplejwt.settings import api_settings

SIMPLE_JWT = {
    'ACCESS_TOKEN_LIFETIME': timedelta(minutes=60),   # Token valid for 15 mins
...
AUTH_PASSWORD_VALIDATORS = [
    ...
    },
    {
        ...
        'OPTIONS': {
            'min_length': 8,  # Recommend minimum length of 8
        }
    },
    {
